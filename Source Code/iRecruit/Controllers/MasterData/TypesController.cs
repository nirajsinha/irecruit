...
namespace iRecruit.Controllers.MasterData
{
    ...
    public class TypesController : ApiController
    {
        ...
        public TypesController(IMasterRepository repo, ITraceWriter logger)
        {
            this._repo = repo;
            this._tracer = logger;
        }
        ...
        public HttpResponseMessage Get()
        {
            try
            {
                List<iRecruit.Entity.Type> obj = _repo.GetTypes();
        ...
        public HttpResponseMessage Get(int typeClassCode, string typeCode)
        {
            try
            {
                iRecruit.Entity.Type obj = _repo.GetType(typeClassCode, typeCode);
                HttpResponseMessage response = Request.CreateResponse(HttpStatusCode.OK, obj);
                return response;
            }
            catch (Exception ex)
