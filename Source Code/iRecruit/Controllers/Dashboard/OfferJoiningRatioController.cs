...
namespace iRecruit.Controllers.Dashboard
{
    ...
    public class OfferJoiningRatioController : ApiController
    {
        private readonly IDashboardRepository _repo;
        private readonly ITraceWriter _tracer;

        public OfferJoiningRatioController(IDashboardRepository repo, ITraceWriter logger)
        {
            this._repo = repo;
            this._tracer = logger;
        }
        ...
        public HttpResponseMessage Get(int id, string b)
        {
            try
            {
                ChartDataModel res = this._repo.OfferJoiningRatio(id);
