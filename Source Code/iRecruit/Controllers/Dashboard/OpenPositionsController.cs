...
namespace iRecruit.Controllers.Dashboard
{
    ...
    public class OpenPositionsController : ApiController
    {
        private readonly IDashboardRepository _repo;
        private readonly ITraceWriter _tracer;

        public OpenPositionsController(IDashboardRepository repo, ITraceWriter logger)
        {
            this._repo = repo;
            this._tracer = logger;
        }
        ...
        public HttpResponseMessage Get(int id)
        {
            try
            {
                OpenPositionsModel res = this._repo.OpenPositionsDetails(id);
