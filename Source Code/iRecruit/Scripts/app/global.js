...
(function ($, document, undefined) {
    ...
    $.toas = function (message, title, type) {
        toastr.options = { closeButton: true, positionClass: "toast-top-full-width" };
        
        if (type == null || type == '') title = 'exclamation';
        if (type == 'info') {
            ...
            // Display an warning toast with no title
...
var sendEmail = function (content, callback) {
    $.ajax({
        url: '/home/postcomments', type: 'POST', contentType: "application/json; charset=utf-8",
...
var submitFeedback = function () {
    var suggesions = encodeURIComponent($("#f_suggesions").val());
    sendEmail(suggesions, function (data, status, headers, config) {
        $("#f_suggesions").val('');
    });
}

var ConvertJsonToCsv = function (JSONData, ReportTitle, ShowLabel) {
